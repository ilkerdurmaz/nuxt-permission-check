<template>
    <div class="container mx-auto p-8">
        ...
        <!-- Header -->
        <h1 class="text-3xl font-medium mb-8">Nuxt Permission Playground</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h2 class="text-xl font-medium mb-4">Permission Manager</h2>
                    <div class="space-y-2">
                        <div v-for="permission in availablePermissions" :key="permission" class="flex items-center">
                            <input
                                ...
                                class="mr-2"
                            >
                            <label :for="permission" class="text-gray-700">{{ permission }}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h2 class="text-xl font-medium mb-4">Active Permissions</h2>
                    <ul class="list-disc list-inside">
                        <li v-for="perm in selectedPermissions" :key="perm" class="text-gray-700">
                            {{ perm }}
                        </li>
                    </ul>
                </div>
            ...
            <div class="space-y-6">
                <!-- Route Permissions -->
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h2 class="text-xl font-medium mb-4">Route Permissions</h2>
                    <div class="space-y-2">
                        <div v-for="(value, route) in $routePermissions" :key="route" class="text-gray-700">
                ...
                <!-- Navigation Links -->
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h2 class="text-xl font-medium mb-4">Navigation</h2>
                    <div class="flex flex-col gap-2">
                        <NuxtLink to="allowed" class="text-blue-500 hover:underline">Allowed</NuxtLink>
                        <NuxtLink to="user1-page" class="text-red-500 hover:underline">User 1 Page</NuxtLink>
                        <NuxtLink to="user2-page" class="text-green-500 hover:underline">User 2 Page</NuxtLink>
                        <NuxtLink to="combined" class="text-green-500 hover:underline">Combined</NuxtLink>
                        <NuxtLink to="any" class="text-yellow-500 hover:underline">Any</NuxtLink>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-12 bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-2xl font-medium mb-4">Quick Start Guide</h2>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <h3 class="text-lg font-medium mb-2">2. Module Setup</h3>
...
export default defineNuxtConfig({
    ...
    nuxtPermissionChecker: {
        ...
        redirect: '/'     // Redirect path for unauthorized access
                ...
                <div>
                    <h3 class="text-lg font-medium mb-2">3. Define Route Permissions</h3>
...
export default defineNuxtPlugin((nuxtApp) => {
    ...
    nuxtApp.$permission.setRoutePermissions(routePermissions);
                ...
                <div>
                    <h3 class="text-lg font-medium mb-2">4. Usage in Components</h3>
                    <pre class="bg-gray-50 p-3 rounded"><code>// Set permissions for current user
const app = useNuxtApp();
app.$permission.setPermissions(['user1:permission']);

// Handle unauthorized access
app.$setUnauthorizedCallback((route, requiredPermissions) => {
    console.log(`Access Denied: Missing permissions (${requiredPermissions}) for ${route}`);
});</code></pre>
                </div>

                <div>
                    <h3 class="text-lg font-medium mb-2">5. Permission Types</h3>
